        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all">
              ...
              <button className="w-full py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 mb-6">Buy Now</button>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-blue-500 shadow-xl relative">
              ...
              <button className="w-full py-3 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 mb-6">Buy Now</button>
              <ul className="space-y-3 text-gray-700">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all">
              ...
              <button className="w-full py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 mb-6">Subscribe</button>
              <ul className="space-y-3 text-gray-700">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-purple-500 shadow-xl relative">
              ...
              <button className="w-full py-3 bg-purple-500 text-white rounded-lg font-semibold hover:bg-purple-600 mb-6">Subscribe</button>
              <ul className="space-y-3 text-gray-700">
