    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all">
              ...
              <button onClick={() => openPayment('0.99', `${t.starter} - 10 credits`, 'pack_10')} className="w-full py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 mb-6">{t.buyNow}</button>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>10 HD removals</span></li>
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>{t.neverExpires}</span></li>
              </ul>
            </div>
            <div className="bg-white rounded-2xl p-8 border-2 border-blue-500 shadow-xl relative">
              ...
              <button onClick={() => openPayment('3.99', `${t.popular} - 50 credits`, 'pack_50')} className="w-full py-3 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 mb-6">{t.buyNow}</button>
              <ul className="space-y-3 text-gray-700">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all relative">
              ...
              <button onClick={() => openPayment('6.99', `${t.proPack} - 100 credits`, 'pack_100')} className="w-full py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 mb-6">{t.buyNow}</button>
              <ul className="space-y-3 text-gray-700">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all">
              ...
              <button onClick={() => openPayment('4.99', `${t.basic} Subscription`, 'sub_basic')} className="w-full py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 mb-6">{t.subscribe}</button>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>100 HD removals/mo</span></li>
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>{t.cancelAnytime}</span></li>
              </ul>
            </div>
            <div className="bg-white rounded-2xl p-8 border-2 border-purple-500 shadow-xl relative">
              ...
              <button onClick={() => openPayment('9.99', `${t.pro} Subscription`, 'sub_pro')} className="w-full py-3 bg-purple-500 text-white rounded-lg font-semibold hover:bg-purple-600 mb-6">{t.subscribe}</button>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>300 HD removals/mo</span></li>
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>{t.prioritySupport}</span></li>
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>{t.cancelAnytime}</span></li>
              </ul>
            </div>
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200 hover:shadow-xl transition-all">
              ...
              <button onClick={() => openPayment('19.99', `${t.premium} Subscription`, 'sub_premium')} className="w-full py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 mb-6">{t.subscribe}</button>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>1000 HD removals/mo</span></li>
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>{t.prioritySupport}</span></li>
                <li className="flex items-start"><span className="text-green-500 mr-2">✓</span><span>{t.batchProcessing}</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center gap-8 text-gray-600 text-sm">
          <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>{t.securePayment}</span></div>
          <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>{t.cancelAnytime}</span></div>
          <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>{t.noHiddenFees}</span></div>
          <div className="flex items-center gap-2"><span className="text-green-500">✓</span><span>{t.refund}</span></div>
        </div>
      </div>
